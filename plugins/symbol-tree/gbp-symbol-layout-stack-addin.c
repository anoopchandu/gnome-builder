                                             ...
                                             gpointer      user_data)
{
  ...
  if (symbol == NULL)
    g_warning ("Failed to find nearest scope");
  else if (self->button != NULL)  /* If we were destroyed, short-circuit */
                                                  ...
                                                  gpointer      user_data)
{
  ...
  if (tree == NULL)
    g_warning ("Failed to get symbol tree");
  if (self->button != NULL)  /* If we were destroyed, short-circuit */
