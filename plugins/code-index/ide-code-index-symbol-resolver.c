...
static void
ide_code_index_symbol_resolver_get_key_cb (GObject      *object,
                                           GAsyncResult *result,
                                           gpointer      user_data)
{
  ...
  key = ide_code_indexer_get_key_finish (code_indexer, result, &error);
                                                    ...
                                                    gpointer             user_data)
{
  ...
  g_message ("Getting key");

  ide_code_indexer_get_key_async (code_indexer,
                                  location,
                                  cancellable,
                                  ide_code_index_symbol_resolver_get_key_cb,
