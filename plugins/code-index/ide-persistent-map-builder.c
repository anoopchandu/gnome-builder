                                   ...
                                   gboolean                 replace)
{
  ...
  if ((value_index = GPOINTER_TO_UINT (g_hash_table_lookup (self->keys_hash, key))))
  ...
  else
    {
       ...
       * where corresponding pointer to GVariant is stored.
       */
                                               ...
                                               gint64                   value)
{
  ...
  g_variant_dict_insert_value (self->metadata, key, g_variant_new ("t", value));
}
                                         ...
                                         GCancellable *cancellable)
{
  ...
  g_variant_dict_insert_value (&dict, "version", g_variant_new ("i", 1));
