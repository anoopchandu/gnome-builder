...
G_DECLARE_INTERFACE (IdeCodeIndexEntry, ide_code_index_entry, IDE, CODE_INDEX_ENTRY, GObject)

struct _IdeCodeIndexEntryInterface
{
  GTypeInterface parent_iface;

  gchar          *(*get_usr)   (IdeCodeIndexEntry *self);
  gchar          *(*get_name)  (IdeCodeIndexEntry *self);
  IdeSymbolKind   (*get_kind)  (IdeCodeIndexEntry *self);
  IdeSymbolFlags  (*get_flags) (IdeCodeIndexEntry *self);
  void            (*get_range) (IdeCodeIndexEntry *self,
                                guint             *begin_line,
...
/* make this const */
gchar           *ide_code_index_entry_get_usr   (IdeCodeIndexEntry *self);
